...
tell application "System Events"
	tell application process "Safari"
		...
		tell window 1
			click button "密碼" of toolbar 1 of it
			repeat until (exists button "加入" of group 1 of group 1 of it)
				if not (exists button "加入" of group 1 of group 1 of it) then
	...
	tell application "System Events"
		tell application process "Safari"
			...
			tell window 1
				...
				click button "加入" of group 1 of group 1 of it
				delay 1
